...
from utils import load_metr_la_rdata, calculate_random_walk_matrix, load_pems04_data, load_pems08_data, \
    load_pemsbay_data, load_chengdu_data, load_sedata
import torch
...
def parse_arg():
    ...
    parser.add_argument('--dataset',type=str,default='sedata',help='name of the datasets,select from metr,nrel,ushcn,sedata of pemsbay')
    parser.add_argument('--n_s',type=int,default=160,help='sampled space dimension')  # n_s=n_o+n_m
