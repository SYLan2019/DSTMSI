...
def parse_arg():
    ...
    parser.add_argument('--gid', type=int, default=1)   #组id，会根据gid生成对应的log文件，如1.log，其中通过id来区分是哪个种子
    parser.add_argument('--subgraph', type=int, default=10)  #
    parser.add_argument('--feed',type=int,default=1024)
